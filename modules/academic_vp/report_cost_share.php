...
<head>
    ...
    <title data-en="Report Cost Share - Academic VP" data-am="የወጪ መጋራት ሪፖርት - የአካዳሚክ ም/ፕሬዚዳንት">Report Cost Share - Academic VP
    </title>
    ...
    <div class="dashboard-container">
        ...
        <div class="layout-body">
            ...
            <div class="main-content">
                <div class="top-bar">
                    <h2 data-en="Report Cost Share (Academic VP)" data-am="የወጪ መጋራት ሪፖርት (የአካዳሚክ ም/ፕሬዚዳንት)">Report Cost Share
                        (Academic VP)</h2>
                </div>
                    ...
                    <form method="GET">
                        <div class="filter-grid">
                            ...
                            <div style="grid-column: span 2; display: flex; gap: 10px;">
                                ...
                                <button type="button" class="btn-secondary" style="flex: 1; background: #6c757d; color: white;" onclick="printReport()">
