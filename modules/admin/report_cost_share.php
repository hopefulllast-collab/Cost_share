...
<head>
    ...
    <title data-en="Report Cost Share" data-am="የወጪ ማጋራት ሪፖርት">Report Cost Share</title>
    ...
    <div class="dashboard-container">
        ...
        <div class="layout-body">
            ...
            <div class="main-content">
                <div class="top-bar">
                    <h2 data-en="Generate Cost Share Report" data-am="የወጪ ማጋራት ሪፖርት ያመንጩ">Generate Cost Share Report
                    </h2>
                </div>
                        ...
                        <div class="filter-grid">
                            ...
                            <div>
                                ...
                                <select name="department_id" id="deptSelect" onchange="loadBatches()">
                                    <option value="" data-en="All Departments" data-am="ሁሉንም ክፍሎች">All Departments
                                    </option>
                                    <!-- Populated via JS -->
                                </select>
                            </div>
                            ...
                            <!-- Semester -->
                            <div>
                                <label data-en="Semester" data-am="ወሰነ ትምህርት">Semester</label>
                            ...
                            <div>
                                ...
                                <select name="sex">
                                    <option value="" data-en="All" data-am="ሁሉንም">All</option>
                            ...
                            <div style="grid-column: span 2; display: flex; gap: 10px;">
                                <button type="submit" class="btn-primary" style="flex: 1;"><i class="fas fa-search"></i>
                                    <span data-en="Search" data-am="ፈልግ">Search</span></button>
                    ...
                    <table class="table-list">
                        ...
                        <tbody>
                            <?php if (empty($reports)): ?>
                                <tr>
                                    <td colspan="7" data-en="No records found." data-am="ምንም መዝገብ አልተገኘም።">No records found.
                                    </td>
                                </tr>
                            <?php else: ?>
                                <?php foreach ($reports as $r): ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if (isset($_GET['status']) && strtolower($_GET['status']) === 'transfer-out') {
