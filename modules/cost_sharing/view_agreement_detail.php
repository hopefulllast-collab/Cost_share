...
$student_user_id = $agreement['user_id'];
...
$student = $pdo->prepare("SELECT s.*, u.first_name, u.middle_name, u.last_name, u.digital_signature, d.name as dept_name, d.college
                          ...
                          WHERE s.user_id = ?");
$student->execute([$student_user_id]);
...
<head>
    ...
    <title data-en="Review Agreement - DMU" data-am="ስምምነትን ይገምግሙ - DMU">Review Agreement - DMU</title>
            ...
            <div class="main-content">
                ...
                <div class="paper-form">
                    ...
                    <div class="actions" style="margin-top: 30px; border-top: 1px solid #eee; padding-top: 20px;">
                        <div
                            style="padding: 12px 16px; background: #e8f4fd; border: 1px solid #b8daff; border-radius: 5px; color: #004085; margin-bottom: 20px;">
                        ...
                        <?php else: ?>
                            <div class="alert-info" data-en="This agreement has already been processed or is not ready for your verification."
                                data-am="ይህ ስምምነት ቀድሞውኑ ተካሂዷል ወይም ለእርስዎ ማረጋገጫ ዝግጁ አይደለም።" style="padding: 15px; background: #d4edda; color: #155724; border-radius: 5px; border: 1px solid #c3e6cb;">
                                This agreement has already been processed or is not ready for your verification.
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
