...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action_type'])) {
    ...
    if ($action_type == 'upload_stamp' && $doc['request_type'] == 'Original') {
        ...
        // Forward according to request type
        if ($doc['request_type'] == 'Original' && strpos($doc['clearance_file'], 'signed_') !== 0) {
            ...
            $new_status = 'Pending Cost Share Pro';
            $r_msg_en = 'Document request forwarded to Cost Sharing Professional.';
            $r_msg_am = 'የሰነድ ጥያቄ ወደ ወጪ መጋራት ባለሙያ ተላልፏል።';
    ...
    <div class="dashboard-container">
        ...
        <div class="layout-body">
            ...
            <div class="main-content">
                <div class="top-bar">
                    <h2 data-en="Review Document Request" data-am="የሰነድ ጥያቄን ይገምግሙ">Review Document Request</h2>
                ...
                <div class="process-layout">
                    ...
                    <div class="file-preview">
                        ...
                        <div
                            ...
                            <?php
                            if ($doc['request_type'] == 'Graduation') {
                                // For graduation, show the generate document preview
                                $preview_url = "preview_request_form.php?id=" . $id;
                                echo "<iframe src='{$preview_url}' style='width:100%; height:100%; border:none;'></iframe>";
                            } else {
                                // Original and others show the uploaded file
                    ...
                    <div class="action-panel">
                        <?php if ($doc['request_type'] == 'Original'): ?>
                        ...
                        <div class="action-box" style="background:#f8f9fa; border-color:#0056b3;">
                            <h4 style="color:#0056b3; border-bottom-color:#b8daff;" data-en="Forward Request"
                                data-am="ጥያቄውን አስተላልፍ">Forward Request</h4>
                            <p style="font-size:13px; color:#333;"
                                data-en="Review the student's request and clearance properly. If it is fine, forward it to the next step."
                                data-am="የተማሪውን ጥያቄ እና ክሊራንስ በጥንቃቄ ይመልከቱ። ትክክል ከሆነ ወደሚቀጥለው ደረጃ ያስተላልፉት።">Review the
                                student's request and clearance properly. If it is fine, forward it to the next step.
                            </p>
                            <form method="POST">
                                <input type="hidden" name="action_type" value="forward">
                                <?php if ($doc['request_type'] == 'Original' && strpos($doc['clearance_file'], 'signed_') !== 0): ?>
                                    <button type="button" class="btn-primary"
                                        ...
                                        <i class="fas fa-lock"></i> <span data-en="Upload Required"
                                            data-am="ለማለፍ መጫን ግዴታ ነው">Upload Required</span>
                                    </button>
                                <?php else: ?>
                                    <button type="submit" class="btn-primary" style="width:100%; margin-top:5px;">
                                        <i class="fas fa-share"></i> <span data-en="Forward to Cost Sharing Pro"
                                            data-am="ወደ ወጪ መጋራት ባለሙያ ላክ">Forward to Cost Sharing Pro</span>
                                    </button>
                                <?php endif; ?>
                            </form>
                        </div>
